/**
 * Parses Nmap XML (from `-oX -`) into the shared ScanResult type.
 * The full untouched xml2js object is retained on `result.raw`.
 */
import { parseStringPromise } from 'xml2js';
import type { ScanResult, ScanHost, ScanPort } from '@portscope/shared';
